...
* **Pharmacognosy:** Isolation and characterization of terrestrial and marine natural products.
* **Bioinformatics and chemoinformatics:** Small-molecule analysis and genomics.
* **Metabolomics:** GC-MS data processing and molecular networking.
---
...
---
## Skills and tools
* **OS:** Ubuntu (Linux CLI and bash scripting)
* **Version control:** Git and GitHub
* **Languages:** Python (learning)
* **Wet Lab:** Chromatography (GC-MS, HPLC), natural product extraction.
* **Languages spoken:** Spanish (native), English (advanced), German (intermediate), French (basic)
## Contact and aff
